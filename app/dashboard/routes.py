...
def list_obligations():
    ...
    # Client dropdown lists every ACTIVE client; the filter narrows both row kinds to one
    # client. Archived (soft-deleted) clients are excluded so they cannot be selected and
    # their stale obligations never surface.
